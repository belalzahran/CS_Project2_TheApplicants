...
public:
    ...
    void setupUi(QWidget *displaySouvenirs)
    {
        ...
        label->setGeometry(QRect(70, 180, 131, 31));
    ...
    void retranslateUi(QWidget *displaySouvenirs)
    {
        ...
        label->setText(QCoreApplication::translate("displaySouvenirs", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:700; text-decoration: underline;\">College Name</span></p></body></html>", nullptr));
    } // retranslateUi
